...
to setup
  ...
  ;; each turtle chooses a random value at the beginning of each simulation
  ask turtles [
    ; select random number between 0 and 20 inclusive
    set max-align-turn random 21
    set max-cohere-turn random 21
    set max-separate-turn random 21
  ]
...
to flock  ;; turtle procedure
  ...
  if not any? flockmates                      ; If a turtle does not find flockmates
  [
    set max-align-turn random 21
    set max-cohere-turn random 21
    set max-separate-turn random 21
